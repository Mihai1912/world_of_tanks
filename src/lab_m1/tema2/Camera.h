...
namespace implemented
{
    class CameraT2
    {
     public:
        ...
        {
            // Translates the CameraT2 using the `dir` vector computed from
            // `forward`. Movement will always keep the CameraT2 at the same
        ...
        {
            // TODO(student): Translate the CameraT2 using the `forward` vector.
        ...
        {
            // TODO(student): Translate the CameraT2 using the `up` vector.
        ...
        void TranslateRight(float distance)
        {
            ...
            // You need to translate the CameraT2 using the `right` vector.
            // Usually, however, translation using CameraT2's `right` vector
            // is not very useful, because if the CameraT2 is rotated around the
            // `forward` vector, then the translation on the `right` direction
            // will have an undesired effect, more precisely, the CameraT2 will
        ...
        {
            // TODO(student): Rotate the CameraT2 in third-person mode around
